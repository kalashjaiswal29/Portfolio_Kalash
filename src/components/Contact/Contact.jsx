    ...
    <footer className={styles.footer} role="contentinfo">
      <div className={`container ${styles.footerInner}`}>
        <span className={styles.footerBrand}>
          J<span className={styles.footerBrandAccent}>CREA</span>
        </span>
...
export default function Contact() {
  ...
  return (
    <>
      {/* ---- CTA Banner ---- */}
      <section className={`${styles.ctaSection} section-padding`} id="cta" aria-label="Project CTA">
      ...
      {/* ---- Full Contact Form ---- */}
      <section className={`${styles.formSection} section-padding`} id="contact" aria-label="Contact Form">
